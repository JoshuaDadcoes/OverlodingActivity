public class App {
    ...
    public static void main(String[] args) throws Exception {
         ...
         */
        System.out.println("Computing the sum of two numbers 10 and 20 = " + App.computeSum(10, 20));
        System.out.println("Computing the sum of three numbers 10, 20, 30 = " + App.computeSum(10, 20, 30));
        /**
